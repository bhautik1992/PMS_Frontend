...
const Create = () => {
  ...
  const validationSchema = Yup.object({
    ...
    price: Yup.string().required().max(5).label("Price"),
    currency: Yup.object().required().label("Currency"),
    billing_cycle: Yup.object().required().label("Billing Cycle"),
    technology: Yup.array().min(1, "Technology is required field"),
    start_date: Yup.string().required().label("Start Date"),
    users_id: Yup.array()
      .min(1, "At least one user must be selected")
      .label("User"),
    client_id: Yup.object().required().label("Client"),
  ...
  useEffect(() => {
    const temp = activeUsers.length > 0 && activeClients.length > 0;
  ...
  const onSubmit = async (values) => {
    try {
      ...
      const endPoint =
        projectId !== undefined ? "projects/update" : "projects/create";
      ...
      (async () => {
        try {
          ...
          const errorMessage =
            ...
            (error.request
              ? import.meta.env.VITE_NO_RESPONSE
              : import.meta.env.VITE_ERROR_MSG);
  ...
  return (
    <Fragment>
      <Helmet>
        <title>
          {projectId !== undefined ? "Edit Project" : "Create Project"} | PMS
        </title>
      </Helmet>
                    ...
                    <Row>
                      ...
                      <Col md="4">
                        ...
                        <Field
                          ...
                          onChange={(event) =>
                            handleNumericInput(event, setFieldValue)
                          }
                          maxLength={5}
                          autoComplete="off"
                        />
                    ...
                    <Row className="mt-1">
                      ...
                      <Col md="4">
                        ...
                        <Select
                          ...
                          onChange={(option) =>
                            setFieldValue("billing_cycle", option)
                          }
                      ...
                      <Col md="4">
                        ...
                        >
                          <ReactTagInput
                            ...
                            onChange={(newTags) =>
                              setFieldValue("technology", newTags)
                            }
                            onBlur={() => setFieldTouched("technology", true)}
                          />
                        </div>
                    ...
                    <Row className="mt-1">
                      ...
                      <Col md="4">
                        ...
                        <Select
                          ...
                          theme={selectThemeColors}
                          className={`react-select ${
                            errors.users_id && touched.users_id && "is-invalid"
                          }`}
                          classNamePrefix="select"
